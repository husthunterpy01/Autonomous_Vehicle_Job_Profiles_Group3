...
INSERT INTO jobposting (
  ...
  (
    ...
    'waymo-software-engineer-perception-mv',
    ...
    185000,
    'USD',
    'Build and ship perception models for Waymo Driver. Work on LiDAR/camera fusion, tracking, and on-vehicle inference.',
    '2026-08-01 09:00:00',
    'Greenhouse',
    0.92,
    '11111111-1111-1111-1111-111111111035'
  ),
  (
    '33333333-3333-3333-3333-333333333002',
    'waymo-ml-engineer-behavior-sf',
    'Machine Learning Engineer, Behavior',
    'Behavior',
    1,
    ...
    220000,
    'USD',
    'Design ML systems for trajectory prediction and decision making in complex urban environments.',
    '2026-08-05 14:30:00',
    'Greenhouse',
    0.90,
    '11111111-1111-1111-1111-111111111035'
  ...
  (
    ...
    'waabi-research-scientist-simulation-toronto',
    ...
    160000,
    'CAD',
    'Advance differentiable simulation and closed-loop evaluation for autonomous trucking.',
    '2026-07-28 11:00:00',
    'Lever',
    0.88,
    '11111111-1111-1111-1111-111111111034'
  ),
  (
    '33333333-3333-3333-3333-333333333004',
    'waabi-software-engineer-infrastructure-sf',
    ...
    175000,
    'USD',
    'Build scalable training and evaluation pipelines for autonomy research workloads.',
    '2026-08-10 16:00:00',
    'Lever',
    0.87,
    '11111111-1111-1111-1111-111111111034'
  ...
  (
    ...
    'bosch-embedded-software-engineer-sunnyvale',
    ...
    145000,
    'USD',
    'Develop safety-critical embedded software for driver-assistance ECUs.',
    '2026-07-15 08:00:00',
    'SmartRecruiters',
    0.85,
  ...
  (
    ...
    'stackav-systems-engineer-pittsburgh',
    'Systems Engineer, Autonomy',
    'Systems',
    1,
    'Pittsburgh, PA, USA',
    3,
    155000,
    'USD',
    'Own cross-stack integration for Stack AV autonomous trucking systems.',
    '2026-08-08 10:15:00',
    'Greenhouse',
    0.91,
  ...
  (
    ...
    'aurora-motion-planning-engineer-pittsburgh',
    ...
    170000,
    'USD',
    'Implement and validate motion planning algorithms for highway and urban trucking routes.',
    '2026-08-03 13:45:00',
    'Greenhouse',
    0.89,
  ...
  (
    ...
    'nvidia-autonomous-vehicle-intern-santaclara',
    ...
    55,
    'USD',
    'Internship supporting NVIDIA DRIVE software stacks, simulation tooling, and AV demos. Hourly rate.',
    '2026-08-12 09:30:00',
    'NVIDIA Careers',
    0.80,
    '11111111-1111-1111-1111-111111111026'
  ),
  (
    '33333333-3333-3333-3333-333333333009',
    'zoox-robotics-software-engineer-fostercity',
    ...
    195000,
    'USD',
    'Lead development of robotics software for Zoox purpose-built robotaxi platforms.',
    '2026-07-22 12:00:00',
    'Zoox Careers',
    0.93,
  ...
  (
    ...
    'motional-safety-engineer-boston',
    ...
    150000,
    'USD',
    'Drive ISO 26262 compliance and hazard analysis for Motional AV software and hardware.',
    '2026-08-06 15:20:00',
    'Greenhouse',
    0.86,
  ...
  (
    ...
    'wayve-applied-scientist-london',
    'Applied Scientist, End-to-End Driving',
    'Research',
    1,
    ...
    110000,
    'GBP',
    'Train and evaluate large-scale end-to-end driving models on diverse real-world fleets.',
    '2026-08-09 10:00:00',
    'Greenhouse',
    0.90,
    '11111111-1111-1111-1111-111111111036'
  ),
  (
    '33333333-3333-3333-3333-333333333012',
    'applied-intuition-simulation-engineer-mv',
    'Simulation Engineer',
    'Simulation',
    1,
    'Mountain View, CA, USA',
    ...
    165000,
    'USD',
    'Build high-fidelity simulation scenarios and tooling for AV validation customers.',
    '2026-08-11 17:00:00',
    'Ashby',
    0.84,
